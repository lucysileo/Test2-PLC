...
char KEYWORDS[] = {"switch", "for", "while", "..."};
...
/******************************************************/
/* look - a function to look up operators and
...
/******************************************************/
/* findChar - a function to get the next character of
...
/******************************************************/
/* getNonBlank - a function to call findChar until it
...
int lex(void) {
	...
	case LETTER:
		addChar();
		findChar();
		while (class == LETTER || class == DIGIT) {
			addChar();
			findChar();
		}
		nextToken = IDENT;
